    ...
    <div className="min-h-screen bg-[#030712] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md glass p-10 rounded-3xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-space-grotesk font-bold text-white">Admin Login</h1>
          <p className="text-gray-400 mt-2 text-center">Enter your credentials to access the dashboard.</p>
        </div>
