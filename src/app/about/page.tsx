  ...
  return (
    <div className="bg-[#030712] min-h-screen text-white overflow-hidden" ref={containerRef}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-[#00E5FF]/10 blur-[120px]" />
      ...
      <section className="relative pt-40 pb-20 px-6 z-10 flex flex-col items-center text-center">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-6 text-sm font-medium text-[#00E5FF]">
          ...
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-space-grotesk font-bold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-500">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#2563EB]">Artificial Intelligence</span>
          </motion.h1>
          <motion.p variants={fadeInUp} className="text-lg md:text-xl text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed">
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/services" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-[#00E5FF] to-[#2563EB] text-white font-bold text-lg hover:shadow-[0_0_30px_-5px_rgba(0,229,255,0.4)] transition-all flex items-center justify-center gap-2">
              Explore Our Services <ArrowRight size={20} />
            </Link>
            <Link href="/contact" className="w-full sm:w-auto px-8 py-4 rounded-xl glass border border-white/10 text-white font-bold text-lg hover:bg-white/5 transition-all">
              Contact Us
            </Link>
          </motion.div>
        </motion.div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <div className="relative">
              <div className="aspect-square rounded-3xl glass border border-white/10 p-2 overflow-hidden relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-[#00E5FF]/20 to-[#8B5CF6]/20 mix-blend-overlay z-10" />
                <div className="w-full h-full bg-[#0a0f1c] rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <Brain className="w-32 h-32 text-[#00E5FF] opacity-80" />
                  <motion.div 
                    animate={{ rotate: 360 }} 
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                    className="absolute inset-0 border-[1px] border-dashed border-[#00E5FF]/30 rounded-full scale-[1.5]"
                  />
                  <motion.div 
                    animate={{ rotate: -360 }} 
                    transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                    className="absolute inset-0 border-[1px] border-dashed border-[#8B5CF6]/30 rounded-full scale-[2]"
                  />
                </div>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-[#00E5FF] to-[#2563EB] rounded-full" />
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              ...
              variants={fadeInUp}
              className="glass p-10 rounded-3xl border border-white/10 hover:border-[#00E5FF]/50 transition-colors group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                <Target className="w-32 h-32 text-[#00E5FF]" />
              </div>
              <div className="w-14 h-14 rounded-2xl bg-[#00E5FF]/10 flex items-center justify-center mb-6 border border-[#00E5FF]/20">
                <Target className="text-[#00E5FF] w-7 h-7" />
              </div>
            ...
            <motion.div 
              initial="hidden" whileInView="visible" viewport={{ once: true }}
              variants={fadeInUp}
              className="glass p-10 rounded-3xl border border-white/10 hover:border-[#8B5CF6]/50 transition-colors group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                <Lightbulb className="w-32 h-32 text-[#8B5CF6]" />
              </div>
              <div className="w-14 h-14 rounded-2xl bg-[#8B5CF6]/10 flex items-center justify-center mb-6 border border-[#8B5CF6]/20">
                <Lightbulb className="text-[#8B5CF6] w-7 h-7" />
              </div>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Comprehensive technology solutions designed for the modern era.</p>
          </div>
          ...
          >
            {[
              { title: "Artificial Intelligence & Machine Learning", icon: <Brain />, color: "from-[#00E5FF] to-[#2563EB]", desc: "Design intelligent AI models, predictive analytics, NLP systems, computer vision applications, recommendation engines, and AI-powered chatbots." },
              { title: "Smart Automation", icon: <Zap />, color: "from-[#8B5CF6] to-[#D946EF]", desc: "Develop AI agents, workflow automation, CRM automation, HR automation, robotic process automation, and business process optimization." },
              ...
              <motion.div key={i} variants={fadeInUp} className="glass p-8 rounded-3xl border border-white/10 group hover:border-white/20 transition-all">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            {[
              ...
              <motion.div key={i} variants={fadeInUp} className="glass p-8 rounded-3xl border border-white/5 hover:bg-white/5 transition-colors">
                <div className="text-[#00E5FF] mb-4">{value.icon}</div>
      ...
      <section className="py-24 px-6 relative z-10 bg-white/5 border-y border-white/10">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 glass rounded-xl border border-white/5 group hover:border-[#00E5FF]/30 transition-colors">
            ...
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden glass border border-white/10 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-[#2563EB]/20 to-[#8B5CF6]/20" />
              <div className="relative z-10 grid grid-cols-3 gap-4 p-8">
                {Array.from({length: 9}).map((_, i) => (
                  <motion.div 
                    ...
                    className="w-16 h-16 glass rounded-2xl flex items-center justify-center border border-white/20"
                  >
                    <Code className="text-white/50 w-6 h-6" />
                  </motion.div>
                ))}
              </div>
            </div>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">A systematic, proven methodology for delivering excellence.</p>
          </div>

          <div className="relative">
            <div className="absolute top-1/2 left-0 right-0 h-1 bg-white/10 -translate-y-1/2 hidden lg:block" />
            <motion.div 
              initial="hidden" whileInView="visible" viewport={{ once: true }}
              variants={stagger}
            ...
            >
              {[
                ...
                <motion.div key={i} variants={fadeInUp} className="flex flex-col items-center text-center group">
                  <div className="w-16 h-16 rounded-full glass border border-white/20 flex items-center justify-center mb-4 group-hover:border-[#00E5FF] group-hover:shadow-[0_0_20px_-5px_rgba(0,229,255,0.5)] transition-all">
                    <span className="text-xl font-bold text-gray-400 group-hover:text-white transition-colors">{i + 1}</span>
                  </div>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            {stats.map((stat, i) => (
              <div key={i} className="text-center p-8 glass rounded-3xl border border-white/5 hover:bg-white/5 transition-colors">
                <div className="text-4xl md:text-5xl font-space-grotesk font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#2563EB] mb-2">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {technologies.map((tech, i) => (
              <motion.div 
                ...
                className="flex items-center gap-2 px-6 py-3 glass rounded-full border border-white/10 hover:border-[#8B5CF6]/50 hover:shadow-[0_0_20px_-5px_rgba(139,92,246,0.3)] transition-all cursor-default"
              >
      ...
      <section className="py-32 px-6 relative z-10 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <motion.div 
            ...
            className="glass p-12 rounded-[3rem] border border-[#00E5FF]/20 relative overflow-hidden"
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
              <Link href="/contact" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-[#00E5FF] to-[#2563EB] text-white font-bold text-lg hover:shadow-[0_0_30px_-5px_rgba(0,229,255,0.4)] transition-all">
                Start Your Project
              </Link>
              <Link href="/contact" className="w-full sm:w-auto px-8 py-4 rounded-xl glass border border-white/10 text-white font-bold text-lg hover:bg-white/10 transition-all">
