  ...
  return (
    <div className="bg-white dark:bg-[#0A0514] min-h-screen text-gray-900 dark:text-white overflow-hidden" ref={containerRef}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#C084FC]/10 blur-[150px]" />
      ...
      <section className="relative pt-40 pb-32 px-6 z-10 flex flex-col items-center text-center">
        <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-5xl mx-auto relative">
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#D946EF]/30 mb-8 text-sm font-medium text-[#D946EF]">
          ...
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-space-grotesk font-bold tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-gray-500 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C084FC] via-[#9333EA] to-[#D946EF]">Artificial Intelligence</span>
          </motion.h1>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="#research-areas" className="w-full sm:w-auto px-10 py-5 rounded-xl bg-gradient-to-r from-[#C084FC] to-[#9333EA] text-white font-bold text-lg hover:shadow-[0_0_40px_-10px_rgba(0,229,255,0.5)] transition-all flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="relative">
              <div className="aspect-square rounded-full glass border border-gray-200 dark:border-white/10 p-2 overflow-hidden flex items-center justify-center group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#D946EF]/20 to-[#C084FC]/20 mix-blend-overlay" />
                <motion.div animate={{ rotate: 360 }} transition={{ duration: 40, repeat: Infinity, ease: "linear" }} className="absolute inset-0 border-2 border-dashed border-[#D946EF]/30 rounded-full scale-[0.8]" />
                <motion.div animate={{ rotate: -360 }} transition={{ duration: 30, repeat: Infinity, ease: "linear" }} className="absolute inset-0 border-2 border-dotted border-[#C084FC]/30 rounded-full scale-[0.6]" />
                <Brain className="w-40 h-40 text-[#D946EF] opacity-90 z-10 group-hover:scale-110 transition-transform duration-700" />
              </div>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="space-y-6">
              ...
              <motion.div variants={fadeInUp} className="w-20 h-1 bg-gradient-to-r from-[#C084FC] to-[#D946EF] rounded-full" />
              <motion.p variants={fadeInUp} className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed font-medium">Research is at the core of everything we build.</motion.p>
      ...
      <section id="research-areas" className="py-24 px-6 relative z-10">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Pushing the boundaries of what is possible in computer science.</p>
          </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i} variants={fadeInUp} className="glass p-6 rounded-2xl border border-gray-200 dark:border-white/10 group hover:border-[#D946EF]/50 transition-all hover:-translate-y-1 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                  <div className="scale-[3]">{area.icon}</div>
                </div>
                <div className="w-12 h-12 rounded-xl bg-[#D946EF]/10 flex items-center justify-center mb-4 text-[#D946EF] border border-[#D946EF]/20">
                  {area.icon}
                </div>
                <h3 className="text-xl font-bold mb-2">{area.title}</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Focus: {area.apps}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 relative z-10 bg-gray-100 dark:bg-white/5 border-y border-gray-200 dark:border-white/10">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Active experiments and developments in our innovation labs.</p>
          </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              ...
              <motion.div key={i} variants={fadeInUp} className="glass rounded-3xl border border-gray-200 dark:border-white/10 overflow-hidden flex flex-col group">
                <div className="h-48 bg-[#0a0f1c] relative overflow-hidden flex items-center justify-center border-b border-gray-200 dark:border-white/5">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#C084FC]/20 to-transparent mix-blend-overlay opacity-50" />
                  <Microscope className="w-20 h-20 text-white/10 group-hover:scale-110 transition-transform duration-500" />
                  <div className="absolute top-4 right-4 px-3 py-1 bg-gray-200 dark:bg-white/10 backdrop-blur-md rounded-full text-xs font-bold text-[#C084FC]">Active Research</div>
                </div>
                <div className="p-8 flex-1 flex flex-col">
                  <h3 className="text-2xl font-bold mb-2">{project.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-6 flex-1">Goal: {project.goal}</p>
                  
                  <div className="mb-6">
                    <div className="flex justify-between text-sm mb-2">
                      <span className="text-gray-600 dark:text-gray-400">Research Progress</span>
                      <span className="text-[#C084FC] font-bold">{project.progress}%</span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-white/10 rounded-full h-2 overflow-hidden">
                      <motion.div 
                        ...
                        className="bg-gradient-to-r from-[#C084FC] to-[#9333EA] h-full rounded-full" 
                      />
                    </div>
                  </div>
                  ...
                  <button className="w-full py-3 rounded-xl bg-gray-100 dark:bg-white/5 hover:bg-white/10 border border-gray-200 dark:border-white/10 transition-colors font-semibold text-sm flex items-center justify-center gap-2">
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">From theoretical concept to production-ready deployment.</p>
          </div>

          <div className="relative">
            <div className="absolute left-[28px] md:left-[50px] top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#C084FC] via-[#D946EF] to-transparent opacity-30" />
            ...
            {[
              ...
              >
                <div className="w-14 h-14 rounded-full glass border border-[#C084FC]/30 flex items-center justify-center shrink-0 z-10 relative bg-white dark:bg-[#0A0514]">
                  <span className="font-bold text-[#C084FC]">{i + 1}</span>
                </div>
                <div className="glass p-6 rounded-2xl border border-gray-200 dark:border-white/10 flex-1 hover:border-[#C084FC]/30 transition-colors">
      ...
      <section className="py-24 px-6 relative z-10 bg-gray-100 dark:bg-white/5 border-y border-gray-200 dark:border-white/10">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Sharing our discoveries with the global AI community.</p>
          </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={i} variants={fadeInUp} className="glass rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden group flex flex-col">
                <div className="p-6 flex-1">
                  <div className="flex justify-between items-center mb-4 text-xs text-gray-600 dark:text-gray-400">
                    <span className="px-3 py-1 bg-[#D946EF]/20 text-[#D946EF] rounded-full font-medium">{pub.cat}</span>
                    <span>{pub.date}</span>
                  </div>
                  <h3 className="text-xl font-bold mb-4 group-hover:text-[#C084FC] transition-colors">{pub.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">An in-depth analysis of methodologies and experimental results validating our approach to scalable artificial intelligence systems.</p>
                </div>
                <div className="p-6 border-t border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-white/5 flex gap-4">
                  <button className="flex-1 py-2 bg-[#9333EA]/20 text-[#9333EA] hover:bg-[#9333EA]/30 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-colors">
                    <BookOpen size={16} /> Read Paper
                  </button>
                  <button className="px-4 py-2 bg-gray-100 dark:bg-white/5 hover:bg-white/10 rounded-lg text-gray-700 dark:text-gray-300 transition-colors">
                    <Download size={16} />
                  </button>
                </div>
              </motion.div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center p-8 glass rounded-3xl border border-gray-200 dark:border-white/5 hover:border-[#D946EF]/30 transition-colors">
                <div className="text-4xl md:text-5xl font-space-grotesk font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#C084FC] to-[#D946EF] mb-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            {[
              ...
              <motion.div 
                ...
                className="flex-1 glass p-6 rounded-2xl border border-gray-200 dark:border-white/10 relative group"
              >
                <div className="text-[#C084FC] font-black text-3xl mb-2">{node.year}</div>
                <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">{node.goal}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-40 px-6 relative z-10 text-center">
        <div className="container mx-auto max-w-5xl">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="glass p-16 rounded-[4rem] border border-[#D946EF]/30 relative overflow-hidden shadow-[0_0_100px_-20px_rgba(139,92,246,0.2)]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#D946EF]/20 via-transparent to-[#C084FC]/20 pointer-events-none" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
              <Link href="/contact" className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-gradient-to-r from-[#D946EF] to-[#C084FC] text-white font-bold text-xl hover:shadow-[0_0_40px_-10px_rgba(139,92,246,0.6)] hover:scale-105 transition-all">
